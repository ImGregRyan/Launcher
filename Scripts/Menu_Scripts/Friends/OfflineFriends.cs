...
public class OfflineFriends : MonoBehaviour, IPointerClickHandler
{
    public void OnDestroy()
    {
        List<GameObject> ListToUse = FriendManager.FriendBoxes["OfflineFriends"];
        ...
        FriendManager.Singleton.OfflineFriendBox.transform.Find("TitleButton").GetComponentInChildren<TMP_Text>().text =
            $"Offline Friends({ListToUse.Count})";
    }
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        if (eventData.button == PointerEventData.InputButton.Right)
        {
            ...
            PopUpMenu.Singleton.OpenMenu(PopUpMenu.MenuType.OfflineFriend);
    ...
    public async void OpenChatWithFriend()
    {
        ...
        if (ChatManager.Singleton.ChatBoxContainer.transform.Find(chatBoxName))
        {
            ...
            chatTab = ChatManager.Singleton.ChatTabContainer.transform.Find(chatBoxName).gameObject;
        }
